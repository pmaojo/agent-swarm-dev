...
class OrchestratorAgent:
    ...
    def fast_classify_stack(self, task: str) -> Optional[str]:
        ...
        <!-- @synapse:rule Target: OrchestratorAgent, Inefficiency Detected: LLM routing is slow, TDD Status: Green, Synapse Tag Injected: Fractal V5 Vector Search Direct Routing -->
        """
        if not self.stub:
            return None
        ...
        try:
            ...
            critical_threshold = 0.2  # Critical threshold for direct assignment (distance)
