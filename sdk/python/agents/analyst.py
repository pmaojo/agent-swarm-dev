...
class AnalystAgent:
    ...
    def optimize_prompt(self, prompt: str) -> str:
        ...
        """
        # <!-- @synapse:rule Target: AnalystAgent/optimize_prompt Inefficiency Detected: Regex compilation inside loop TDD Status: Green/Refactor Synapse Tag Injected: Precompile regex and use lstrip for fast whitespace stripping -->
