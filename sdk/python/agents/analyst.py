...
# @synapse:rule Utilize pre-compiled module-level regular expressions like `_LEADING_WS_RE`, `_MULTI_SPACE_RE`, and `_MULTI_NEWLINE_RE` to safely and efficiently collapse redundant spaces reducing CPU cycles without corrupting code formatting.
