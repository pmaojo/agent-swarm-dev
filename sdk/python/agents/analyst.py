...
# @synapse:rule Pre-compile regular expressions at the module level for cpu efficiency.
...
class AnalystAgent:
    ...
    def optimize_prompt(self, prompt: str) -> str:
        ...
        # @synapse:rule Use module-level pre-compiled regular expressions to safely and efficiently collapse redundant inline spaces and newlines, reducing token usage and CPU cycles without corrupting code formatting.
