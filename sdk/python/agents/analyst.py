...
class AnalystAgent:
    ...
    def optimize_prompt(self, prompt: str) -> str:
        ...
        # @synapse:constraint Use module-level pre-compiled regex for _LEADING_WS_RE, _MULTI_SPACE_RE, and _MULTI_NEWLINE_RE to improve prompt optimization performance.
