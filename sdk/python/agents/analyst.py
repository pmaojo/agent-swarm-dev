...
class AnalystAgent:
    ...
    def optimize_prompt(self, prompt: str) -> str:
        ...
        # @synapse:rule Cache pre-compiled regular expressions (_LEADING_WS_RE, _MULTI_SPACE_RE, _MULTI_NEWLINE_RE) at the module level to avoid redundant regex compilation overhead inside loops.
