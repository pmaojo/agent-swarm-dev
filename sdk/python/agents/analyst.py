...
class AnalystAgent:
    ...
    def optimize_prompt(self, prompt: str) -> str:
        ...
        # @synapse:rule Cache compiled regular expressions (_LEADING_WS_RE, _MULTI_SPACE_RE, _MULTI_NEWLINE_RE) at the module level to avoid redundant compilation overhead during prompt optimization.
