...
# @synapse:constraint Pre-compile regular expressions at the module level to reduce token usage and CPU cycles, improving processing efficiency for large prompts.
