...
# Pre-compile regexes for prompt optimization efficiency
...
class AnalystAgent:
    ...
    def optimize_prompt(self, prompt: str) -> str:
        ...
        # @synapse:constraint Compile regexes at the module level to avoid re-compilation overhead during repetitive optimization calls.
