...
export const mockGameState: GameState = {
  ...
  repositories: [
    { id: "repo-root", name: "Main Citadel", path: "/workspace/agent-swarm-dev", tasks_pending: 6, status: "ok", size: 1024 },
  ],
  active_quests: [
  ...
  knowledge_tree: [
    ...
    },
    {
      ...
      level: 2,
      prerequisites: ["tdd-level-1"],
      cost: { budget: 3.5, time_hours: 5 },
      unlocked: false,
    },
    {
      id: "threat-modeling",
      ...
      capability: "Checklist STRIDE pre-merge",
      level: 1,
      prerequisites: [],
      cost: { budget: 2.5, time_hours: 4 },
      unlocked: true,
    },
    {
      id: "profiling-base",
      domain: "Performance",
      name: "Profiling Base",
      capability: "Baseline de latencia por módulo",
      level: 1,
      prerequisites: [],
      cost: { budget: 2.0, time_hours: 3 },
      unlocked: true,
    },
    {
      ...
      domain: "DX",
      name: "DX Templates",
      capability: "Plantillas listas para historias y PRs",
      level: 1,
      prerequisites: [],
      cost: { budget: 1.5, time_hours: 2 },
      unlocked: false,
    },
    {
      id: "workflow-mapping",
      ...
      capability: "Mapa agente->dominio->objetivo",
      level: 1,
      prerequisites: [],
      cost: { budget: 2.0, time_hours: 3 },
      unlocked: false,
